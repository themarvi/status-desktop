...
OnboardingBasePage {
    ...
    StackLayout {
        ...
        CreatePasswordView {
            ...
            onFinished: {
                d.newPassword = createPassView.newPassword
                d.confirmationPassword = createPassView.confirmationPassword
        ...
        ConfirmPasswordView {
            ...
            onFinished: { gotoKeysStack(GenKeyView.KeysStack.TOUCH_ID) }
