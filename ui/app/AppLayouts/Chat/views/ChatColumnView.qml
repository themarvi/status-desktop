                    ...
                    ColumnLayout {
                        ...
                        Item {
                            ...
                            StatusChatInput {
                                ...
                                recentStickers: root.rootStore.stcikersModuleInst.recent
                                stickerPackList: root.rootStore.stcikersModuleInst.stickerPacks
                                ...
                                onStickerSelected: {
                                    root.rootStore.stcikersModuleInst.send(root.rootStore.chatsModelInst.channelView.activeChannel.id,
                                                                           hashId,
